 ...
 */
final class Version20230308180343 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tache ADD CONSTRAINT FK_9387207584E66085 FOREIGN KEY (developpeur_id) REFERENCES user (id)');
